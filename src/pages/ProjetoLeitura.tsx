...
export default function ProjetoLeitura() {
  const [projetos, setProjetos] = useState<ProjetoLeitura[]>([
    {
      id: 1,
      turmas_id: 1,
      professores_id: 1,
      titulo: "Análise do livro 'To Kill a Mockingbird'",
      status: "Avaliado",
      descricao: "Leitura e análise crítica do clássico da literatura americana, focando nos temas de justiça social e preconceito.",
      arquivo_url: "analise_mockingbird.pdf",
    ...
    },
    {
      ...
      turmas_id: 2,
      professores_id: 2,
      titulo: "Resenha de 'The Great Gatsby'",
      status: "Em Andamento",
      descricao: "Projeto de leitura com foco na análise dos personagens e contexto histórico dos anos 1920.",
      arquivo_url: "",
    ...
    },
    {
      ...
      turmas_id: 3,
      professores_id: 1,
      titulo: "Leitura de contos de Edgar Allan Poe",
      status: "Entregue",
      descricao: "Análise de três contos selecionados, explorando elementos do gótico americano.",
      arquivo_url: "analise_poe.docx",
  ...
  const [projetoEditando, setProjetoEditando] = useState<ProjetoLeitura | null>(null);

  const [novoProjeto, setNovoProjeto] = useState<Omit<ProjetoLeitura, 'id'>>({
    turmas_id: 0,
    professores_id: 0,
    titulo: '',
    status: 'Pendente',
  ...
  const abrirDialog = (projeto?: ProjetoLeitura) => {
    if (projeto) {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <PageHeader 
        ...
        subtitulo="Gerencie os projetos de leitura das turmas"
      />
      ...
      {projetos.length === 0 && (
        <Paper sx={{ p: 4, textAlign: 'center', mt: 3 }}>
          ...
          <Typography variant="h6" color="text.secondary" gutterBottom>
            Nenhum projeto de leitura encontrado
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            Comece adicionando um novo projeto de leitura
          </Typography>
      ...
      <Dialog open={dialogAberto} onClose={fecharDialog} maxWidth="md" fullWidth>
        <DialogTitle>
          {projetoEditando ? 'Editar Projeto de Leitura' : 'Novo Projeto de Leitura'}
        </DialogTitle>
        <DialogContent>
          <Grid container spacing={2} sx={{ mt: 1 }}>
            <Grid item xs={12}>
              <TextField
                ...
                placeholder="Ex: Análise do livro 'Pride and Prejudice'"
              />
            </Grid>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                placeholder="Descreva os objetivos e requisitos do projeto de leitura..."
              />
            </Grid>
